...
#+end_src
From *Transcendence* to *Acceptance* the following worked, although there is some problem with the *backup-dir*
#+begin_src bash
rsync -vaib --delete --backup-dir=/tmp/backup/ -e ssh /home/iain/Documents/bookshelf/ iain@acceptance.local:/Volumes/Crucial/bookshelf/
#+end_src
* Music
...
Use this to sync to *transcendence*
#+begin_src bash
rsync -vaib --delete --backup-dir=/tmp/backup -e ssh ~/Documents/org-mode iain@transcendence.local:/home/iain/Documents/org-mode
#+end_src
And this to sync from *transcendence*
#+begin_src bash
rsync -vrltgoDb -e ssh /home/iain/Documents/org-mode iain@acceptance.local:/Users/iain/Documents/
#+end_src
The options could be the same, but at one point I was getting an error:
rsync(83087): error: org-mode/NotationalVelocity/2507311346 transcendence install.org~~: fchownat: Operation not permitted
This Stack Overflow [[https://stackoverflow.com/a/30717322/1671119][answer]] suggests the above which is the equivalent, but without the option to set ownership.

* Unison
[[https://raw.githubusercontent.com/bcpierce00/unison/documentation/unison-manual.pdf][manpage]]
From the manual:
You can give an explicit path for the unison executable on the server by using the command-line option -servercmd /full/path/name/of/unison
...
unison a.tmp ssh://remotehostname//absolute/path/to/a.tm

#+begin_src shell
unison -servercmd /opt/homebrew/bin/unison /home/iain/Documents/org-mode ssh://acceptance.local/Documents/org-mode
#+end_src
